...
D_std=plot_data[0][2]
plt.imshow(D_std,interpolation='nearest',extent=(alpha_m_range[0]-0.05,alpha_m_range[-1]+0.05,alpha_n_range[-1]+0.05,alpha_n_range[0]-0.05), cmap='jet')
...
D_std=plot_data[1][2]
plt.imshow(D_std,interpolation='nearest',extent=(alpha_n_range[0]-0.05,alpha_n_range[-1]+0.05,phi_range[-1]+0.05,phi_range[0]-0.05), cmap='jet')
...
for m in range(0,3):
    ...
    plt.imshow(M,interpolation='nearest',extent=(alpha_m_range[0]-0.05,alpha_m_range[-1]+0.05,alpha_n_range[-1]+0.05,alpha_n_range[0]-0.05), cmap='jet')
    ...
    plt.imshow(M,interpolation='nearest',extent=(alpha_n_range[0]-0.05,alpha_n_range[-1]+0.05,phi_range[-1]+0.05,phi_range[0]-0.05), cmap='jet')
